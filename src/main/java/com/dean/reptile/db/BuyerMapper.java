...
public interface BuyerMapper {
    ...
    @Insert({"insert into buyer(`jewelry_id`, `buyer_name`, `number`, `price`, `create_date`, `date`, `create_time`, "
    ...
    @Update({"update buyer set number=#{number}, price=#{price}, update_time=#{updateTime}, date=#{date}, "
